...
module.exports = {
  ...
  noun: "Smart-Contract Function on Fantom chain",

  display: {
    label: "Smart-Contract Function on Fantom chain",
    description: "Sends transaction to the smart-contract on Fantom chain.",
  },
